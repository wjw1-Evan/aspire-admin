  ...
  return (
    <div style={{ padding: '16px 0' }}>
      ...
      <ul>
        <li>
          <a
            href="https://github.com/your-repo/aspire-admin/blob/main/docs/features/BACKEND-RULES.md"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://github.com/your-repo/aspire-admin/blob/main/docs/features/API-RESPONSE-RULES.md"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://github.com/your-repo/aspire-admin/blob/main/docs/features/MENU-LEVEL-PERMISSION-GUIDE.md"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://github.com/your-repo/aspire-admin/blob/main/docs/features/FRONTEND-RULES.md"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="https://github.com/your-repo/aspire-admin/blob/main/docs/features/DATABASE-OPERATION-FACTORY-GUIDE.md"
            target="_blank"
            rel="noreferrer"
          >
