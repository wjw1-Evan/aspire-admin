 ...
 * 可复用的主题设置面板
 */
export const ThemeSettingsDrawer: React.FC<ThemeSettingsDrawerProps> = ({ open, onClose }) => {
  const intl = useIntl();
  ...
  const handleThemeChange = (theme: 'light' | 'dark' | 'realDark') => {
    ...
    messageApi.success(intl.formatMessage({ id: 'app.setting.themeChangeSuccess' }));
  };
