export default {
  ...
  'menu.change-password': 'تغيير كلمة المرور',
  'menu.system': 'النظام',
  'menu.system.desc': 'وظائف إدارة النظام',
  'menu.system.user-management': 'إدارة المستخدمين',
  'menu.system.role-management': 'إدارة الأدوار',
  'menu.system.menu-management': 'إدارة القوائم',
  'menu.system.user-log': 'سجل المستخدم',
  'menu.user-log': 'سجل نشاط المستخدم',
  'menu.system.company-settings': 'إعدادات الشركة',
  'menu.system.company-management': 'إدارة الشركات',
  'menu.system.organization': 'المنظمة',
  'menu.system.my-activity': 'نشاطاتي',
  ...
  'menu.account.center.desc': 'إدارة المعلومات الشخصية والإعدادات',
  'menu.account.changePassword': 'تغيير كلمة المرور',
  'menu.account.settings': 'الإعدادات',
  'menu.account.help': 'المساعدة',
  'menu.account.logout': 'تسجيل الخروج',
  'menu.account.company': 'تبديل الشركة',
  'menu.account.language': 'تبديل اللغة',
  // Workflow Management
