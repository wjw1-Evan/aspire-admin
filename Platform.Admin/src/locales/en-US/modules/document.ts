...
export default {
  ...
  'pages.document.status.archived': 'Archived',
...
'pages.document.statistics.approved': 'Approved',
  ...
  'pages.document.action.archive': 'Archive',
  'pages.document.message.confirmArchive': 'Are you sure you want to archive document {title}?',
  'pages.document.message.archiveSuccess': 'Archive successful',
  'pages.document.confirm': 'Confirm',
