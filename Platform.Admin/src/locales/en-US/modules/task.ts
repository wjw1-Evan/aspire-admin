...
export default {
  ...
  'pages.taskManagement.execution.currentStatus': 'Current Status',
  'pages.taskManagement.execution.currentProgress': 'Current Progress',
  'pages.taskManagement.execution.mode': 'Execution Mode',
  'pages.taskManagement.execution.modeProgress': 'Update Progress',
  'pages.taskManagement.execution.modeComplete': 'Complete Task',
  'pages.taskManagement.execution.updateProgressDesc': 'Update task execution progress, status will change to \'In Progress\'',
  'pages.taskManagement.execution.completeTaskDesc': 'Mark task as completed, need to specify execution result',
  'pages.taskManagement.execution.completionPercentageRequired': 'Please set completion percentage',
  'pages.taskManagement.execution.messagePlaceholder': 'Please enter execution message or remarks',
  ...
  'pages.taskManagement.execution.errorMessagePlaceholder': 'Please enter failure reason or error message',
  'pages.taskManagement.execution.remarks': 'Completion Remarks',
  'pages.taskManagement.execution.remarksPlaceholder': 'Please enter task completion remarks',
  'pages.taskManagement.execution.progressUpdated': 'Task progress updated',
  'pages.taskManagement.execution.taskCompleted': 'Task completed',
  'pages.taskManagement.execution.updateProgressFailed': 'Failed to update task progress',
  'pages.taskManagement.execution.completeTaskFailed': 'Failed to complete task',
};
