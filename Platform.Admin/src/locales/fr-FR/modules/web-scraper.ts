...
export default {
  ...
  'pages.web-scraper.titleSelectorTooltip':
    'Sélecteur CSS pour extraire le titre de la page, laisser vide pour utiliser la balise <title>',
  ...
  'pages.web-scraper.contentSelectorTooltip':
    'Sélecteur CSS pour extraire le contenu principal, laisser vide pour utiliser la balise <body>',
  ...
  'pages.web-scraper.scheduleCronTooltip':
    '<p>Exemples courants:</p><ul><li>Toutes les 10 minutes: <code>*/10 * * * *</code></li><li>Toutes les heures: <code>0 * * * *</code></li><li>Chaque jour à minuit: <code>0 0 * * *</code></li><li>Chaque lundi: <code>0 0 * * 1</code></li></ul>',
