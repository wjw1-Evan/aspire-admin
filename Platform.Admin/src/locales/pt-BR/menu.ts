export default {
  ...
  'menu.account.company': 'Trocar Empresa',
  'menu.account.language': 'Trocar Idioma',
  // Gerenciamento de Fluxo de Trabalho
  'menu.workflow': 'Gerenciamento de Fluxo de Trabalho',
  'menu.workflow.list': 'Definições de Fluxo',
  'menu.workflow.list.desc': 'Gerenciar e configurar definições de fluxo de trabalho',
  'menu.workflow.create': 'Criar Fluxo',
  ...
  'menu.document.list.desc': 'Visualizar e gerenciar documentos',
  'menu.document.create': 'Criar Documento',
  'menu.document.create.desc': 'Criar novo documento',
  'menu.document.approval': 'Minhas Aprovações',
  'menu.document.approval.desc': 'Processar aprovações de documentos pendentes',
