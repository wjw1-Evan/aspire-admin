export default {
  ...
  'menu.change-password': 'Смена пароля',
  'menu.system': 'Система',
  'menu.system.desc': 'Функции управления системой',
  'menu.system.user-management': 'Управление пользователями',
  'menu.system.role-management': 'Управление ролями',
  'menu.system.menu-management': 'Управление меню',
  'menu.system.user-log': 'Журнал пользователей',
  'menu.user-log': 'Журнал активности пользователей',
  'menu.system.company-settings': 'Настройки компании',
  'menu.system.company-management': 'Управление компаниями',
  'menu.system.organization': 'Организация',
  'menu.system.my-activity': 'Моя активность',
  ...
  'menu.account.center.desc': 'Управление личной информацией и настройками',
  'menu.account.changePassword': 'Сменить пароль',
  'menu.account.settings': 'Настройки',
  'menu.account.help': 'Помощь',
  'menu.account.logout': 'Выйти',
  'menu.account.company': 'Сменить компанию',
  'menu.account.language': 'Сменить язык',
  // Workflow Management
