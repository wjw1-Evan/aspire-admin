      ...
      <ProCard
        title={
          <Space size={24}>
            ...
            <Space size={12}>
              <Tag color="blue">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.totalGateways' })}{' '}
                {state.statistics?.totalGateways || 0}
              </Tag>
              <Tag color="green">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.onlineGateways' })}{' '}
                {state.statistics?.onlineGateways || 0}
              </Tag>
              <Tag color="cyan">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.totalDevices' })}{' '}
                {state.statistics?.totalDevices || 0}
              </Tag>
              <Tag color="lime">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.onlineDevices' })}{' '}
                {state.statistics?.onlineDevices || 0}
              </Tag>
              <Tag color="purple">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.totalDataPoints' })}{' '}
                {state.statistics?.totalDataPoints || 0}
              </Tag>
              <Tag color="orange">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.totalAlarms' })}{' '}
                {state.statistics?.totalAlarms || 0}
              </Tag>
              <Tag color="red">
                {intl.formatMessage({ id: 'pages.iotPlatform.statistics.unhandledAlarms' })}{' '}
