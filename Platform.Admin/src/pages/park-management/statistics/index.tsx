...
const api = {
  ...
  investmentStatistics: (startDate?: string, endDate?: string) =>
    request<ApiResponse<InvestmentStatistics>>('/apiservice/api/park/investment/statistics', {
      method: 'GET',
      params: { startDate, endDate },
    }),
  tenantStatistics: (startDate?: string, endDate?: string) =>
    request<ApiResponse<TenantStatistics>>('/apiservice/api/park/tenant/statistics', {
      method: 'GET',
      params: { startDate, endDate },
    }),
  serviceStatistics: (startDate?: string, endDate?: string) =>
    request<ApiResponse<ServiceStatistics>>('/apiservice/api/park/services/statistics', {
      method: 'GET',
      params: { startDate, endDate },
    }),
...
const StatisticsPage: React.FC = () => {
  ...
  const [state, setState] = useState({
    ...
    statistics: {
      asset: null as AssetStatistics | null,
      investment: null as InvestmentStatistics | null,
      tenant: null as TenantStatistics | null,
      service: null as ServiceStatistics | null,
    },
  ...
  const _renderTrend = (value?: number, isYoY = true) => {
    if (value === undefined || value === null) return null;
    const isUp = value >= 0;
    const color = isUp ? '#52c41a' : '#f5222d';
    const label = isYoY
      ? intl.formatMessage({ id: 'pages.park.statistics.yoy' })
      : intl.formatMessage({ id: 'pages.park.statistics.mom' });
    return (
  ...
  const renderOverview = () => {
    ...
    const calculatedOccupancyRate =
      asset && asset.totalRentableArea > 0 ? (asset.rentedArea / asset.totalRentableArea) * 100 : 0;
    const collectionRate =
      tenant?.totalExpected && tenant.totalExpected > 0
          ...
          <Col xs={24} sm={12} lg={6}>
            <ProCard style={{ height: 140, padding: '12px 16px' }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(0,0,0,0.45)' }}>
                ...
                <span style={{ color: Number(collectionRate) >= 90 ? '#52c41a' : '#faad14' }}>{collectionRate}%</span>
              </div>
            </ProCard>
          </Col>
          <Col xs={24} sm={12} lg={6}>
            <ProCard style={{ height: 140, padding: '12px 16px' }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(0,0,0,0.45)' }}>
                ...
                {intl.formatMessage({ id: 'pages.park.statistics.vacantLabel' })} {vacantArea.toLocaleString()}
                {intl.formatMessage({ id: 'pages.park.statistics.areaSquareMeters' })}
              </div>
              <Progress
          ...
          <Col xs={24} sm={12} lg={6}>
            <ProCard style={{ height: 140, padding: '12px 16px' }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(0,0,0,0.45)' }}>
                ...
                {Number(investment?.conversionRate || 0).toFixed(1)}%
              </div>
            </ProCard>
          </Col>
          <Col xs={24} sm={12} lg={6}>
            <ProCard style={{ height: 140, padding: '12px 16px' }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(0,0,0,0.45)' }}>
                ...
                <span style={{ color: (service?.pendingRequests || 0) > 0 ? '#faad14' : 'inherit' }}>
                  {service?.pendingRequests || 0}
                </span>{' '}
                | {intl.formatMessage({ id: 'pages.park.statistics.ratingLabel' })}{' '}
                <span style={{ color: '#faad14' }}>{service?.averageRating || 5.0}★</span>
              </div>
            </ProCard>
          </Col>
        </Row>
          ...
          <Col xs={24} lg={12}>
            <ProCard
              title={
                <Space>
                  ...
                  {intl.formatMessage({ id: 'pages.park.statistics.investmentOverview' })}
                </Space>
              }
            ...
            >
              <Row gutter={[16, 16]}>
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.totalLeadsLabel' })}
                ...
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.projectsInNegotiationLabel' })}
                ...
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.conversionRateLabel' })}
            ...
            <ProCard
              title={
                <Space>
                  ...
                  {intl.formatMessage({ id: 'pages.park.statistics.serviceOverview' })}
                </Space>
              }
              style={{ marginBottom: 24, borderRadius: 8 }}
            >
              <Row gutter={[16, 16]}>
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.totalRequestsLabel' })}
                ...
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.pendingLabel' })}
                ...
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.completedLabel' })}
                ...
                <Col span={12}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.avgRatingLabel' })}
  ...
  const renderAssetAnalysis = () => {
    ...
    return (
      <div>
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: 22, fontWeight: 500, color: '#faad14' }}>
                    {asset.totalRentableArea.toLocaleString()}{' '}
                    {intl.formatMessage({ id: 'pages.park.statistics.areaSquareMeters' })}
                  </div>
                </div>
              </div>
          ...
          <Col xs={24} sm={12} lg={6}>
            <ProCard style={{ height: 140, padding: '12px 16px' }}>
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 22,
                      fontWeight: 500,
                      color: Number(areaPercent) >= 80 ? '#52c41a' : Number(areaPercent) >= 50 ? '#faad14' : '#f5222d',
                    }}
                  >
                    {areaPercent}%
                  </div>
              ...
              <Progress
                ...
                showInfo={false}
                size="small"
                strokeColor={Number(areaPercent) >= 80 ? '#52c41a' : Number(areaPercent) >= 50 ? '#faad14' : '#f5222d'}
              />
            </ProCard>
          </Col>
        </Row>
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.areaDistribution' })}>
              <div style={{ textAlign: 'center', padding: 24 }}>
                ...
                <Row gutter={16} style={{ marginTop: 24 }}>
                  <Col span={12}>
                    <Statistic
                      title={intl.formatMessage({ id: 'pages.park.statistics.rentedAreaLabel2' })}
                      value={asset.rentedArea}
                      suffix={intl.formatMessage({ id: 'pages.park.statistics.areaSquareMeters' })}
                      styles={{ content: { color: '#52c41a' } }}
                    />
                  </Col>
                  <Col span={12}>
                    <Statistic
                      title={intl.formatMessage({ id: 'pages.park.statistics.availableUnitsLabel' })}
          ...
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.unitDistribution' })}>
              <div style={{ textAlign: 'center', padding: 24 }}>
                <Progress
                  type="dashboard"
                ...
                <Row gutter={16} style={{ marginTop: 24 }}>
                  <Col span={12}>
                    <Statistic
                      title={intl.formatMessage({ id: 'pages.park.statistics.rentedUnitsLabel' })}
                      value={asset.rentedUnits}
                      suffix={intl.formatMessage({ id: 'pages.park.statistics.unit' })}
                      styles={{ content: { color: '#52c41a' } }}
                    />
                  </Col>
                  <Col span={12}>
  ...
  const renderInvestmentAnalysis = () => {
    ...
    return (
      <div>
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 22,
                      fontWeight: 500,
                      color: investment.conversionRate >= 30 ? '#52c41a' : '#faad14',
                    }}
                  >
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.leadsByStatusLabel' })}>
              {leadsByStatusData.length > 0 ? (
                <ProTable
                  ...
                  columns={[
                    ...
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.percentage' }),
                      render: (_: any, record) => {
                        const percent =
                          investment.totalLeads > 0 ? ((record.count / investment.totalLeads) * 100).toFixed(1) : 0;
          ...
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.projectsByStageLabel' })}>
  ...
  const renderTenantAnalysis = () => {
    ...
    return (
      <div>
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.industryDistribution' })}>
              {industryData.length > 0 ? (
                <ProTable
                  ...
                  columns={[
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.industry' }),
                      dataIndex: 'industry',
                      render: (industry) => <Tag color="blue">{industry}</Tag>,
                    },
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.tenantCount' }),
                      dataIndex: 'count',
                      render: (count) => <Text strong>{count}</Text>,
                    },
                    {
                      ...
                      render: (_: any, record) => {
                        const percent =
                          tenant.totalTenants > 0 ? ((record.count / tenant.totalTenants) * 100).toFixed(1) : 0;
                        return <Progress percent={Number(percent)} size="small" />;
                      },
                    },
                  ]}
          ...
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.paymentComposition' })}>
              {paymentTypeData.length > 0 ? (
                <ProTable
                  ...
                  columns={[
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.paymentType' }),
                      dataIndex: 'type',
                      render: (t) => <Tag color="cyan">{t}</Tag>,
                    },
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.receivedAmount' }),
                      dataIndex: 'amount',
                      render: (a) =>
                        a !== null && a !== undefined ? (
                          <Text strong>¥{a.toLocaleString()}</Text>
                        ) : (
                          <Text strong>-</Text>
                        ),
                    },
                    {
                      ...
                      render: (_: any, record) => {
                        const percent =
                          tenant.totalReceived > 0 ? ((record.amount / tenant.totalReceived) * 100).toFixed(1) : 0;
                ...
                <div style={{ textAlign: 'center', padding: '40px 0' }}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.totalReceivedLabel' })}
                    value={tenant.totalReceived}
                    prefix="¥"
                    precision={2}
                  />
                  <Empty description={intl.formatMessage({ id: 'pages.park.statistics.noDetailData' })} />
                </div>
              )}
            </ProCard>
          </Col>
        ...
        <Row gutter={[24, 24]} style={{ marginTop: 24 }}>
          <Col span={24}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.collectionStatus' })}>
              <Row gutter={16}>
                <Col span={6}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.totalExpectedAmountLabel' })}
                ...
                <Col span={6}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.expiringContractsLabel' })}
                ...
                <Col span={6}>
                  <Statistic
                    title={intl.formatMessage({ id: 'pages.park.statistics.collectionRateLabel' })}
  ...
  const renderServiceAnalysis = () => {
    ...
    return (
      <div>
        ...
        <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
          <Col xs={24} sm={12} lg={8}>
            <ProCard style={{ height: 100, padding: '12px 16px' }}>
              <div
                style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}
              >
                <div>
                  ...
                  <div
                    style={{
                      fontSize: 22,
                      fontWeight: 500,
                      color: service.pendingRequests > 10 ? '#f5222d' : '#faad14',
                    }}
                  >
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.requestStatusDistribution' })}>
              {statusData.length > 0 ? (
                <ProTable
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      render: (_: any, record: any) => {
                        const percent =
                          service.totalRequests > 0 ? ((record.count / service.totalRequests) * 100).toFixed(1) : 0;
                        return <Progress percent={Number(percent)} size="small" />;
                      },
                    },
                  ]}
          ...
          <Col xs={24} lg={12}>
            <ProCard title={intl.formatMessage({ id: 'pages.park.statistics.requestCategoryStatistics' })}>
              {categoryData.length > 0 ? (
                <ProTable
                  ...
                  columns={[
                    {
                      title: intl.formatMessage({ id: 'pages.park.statistics.category' }),
                      dataIndex: 'category',
  ...
  const tabItems = [
    {
      key: 'overview',
      label: intl.formatMessage({ id: 'pages.park.statistics.overview' }),
      children: renderOverview(),
    },
    {
      key: 'asset',
      label: intl.formatMessage({ id: 'pages.park.statistics.assetAnalysis' }),
      children: renderAssetAnalysis(),
    },
    {
      key: 'investment',
      label: intl.formatMessage({ id: 'pages.park.statistics.investmentAnalysis' }),
      children: renderInvestmentAnalysis(),
    },
    {
      key: 'tenant',
      label: intl.formatMessage({ id: 'pages.park.statistics.tenantAnalysis' }),
      children: renderTenantAnalysis(),
    },
    {
      key: 'service',
      label: intl.formatMessage({ id: 'pages.park.statistics.serviceAnalysis' }),
    ...
    <PageContainer>
      <div style={{ marginBottom: 16, textAlign: 'right' }}>
        <Space wrap>
          ...
          >
            {intl.formatMessage({ id: 'pages.park.statistics.aiReport' })}
          </Button>
      ...
      >
        <Spin
          spinning={state.aiReportLoading}
