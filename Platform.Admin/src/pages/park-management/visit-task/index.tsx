    ...
    return (
        <PageContainer>
            ...
            <ModalForm key={state.editingTask?.id || 'create'} title={state.editingTask ? intl.formatMessage({ id: 'pages.park.visitTask.edit' }) : intl.formatMessage({ id: 'pages.park.visitTask.create' })} open={state.formVisible}
                ...
                <Row gutter={16}><Col span={12}><ProFormSelect name="visitType" label={intl.formatMessage({ id: 'pages.park.visitTask.visitType' })} initialValue="日常走访" options={[{ value: '日常走访', label: intl.formatMessage({ id: 'pages.park.visitTask.visitType.daily' }) }, { value: '安全检查', label: intl.formatMessage({ id: 'pages.park.visitTask.visitType.safety' }) }, { value: '政策宣讲', label: intl.formatMessage({ id: 'pages.park.visitTask.visitType.policy' }) }, { value: '需求调研', label: intl.formatMessage({ id: 'pages.park.visitTask.visitType.survey' }) }, { value: '其他', label: intl.formatMessage({ id: 'pages.park.visitTask.visitType.other' }) }]} /></Col><Col span={12}><ProFormSelect name="visitMethod" label={intl.formatMessage({ id: 'pages.park.visitTask.visitMethod' })} initialValue="实地走访" options={[{ value: '实地走访', label: intl.formatMessage({ id: 'pages.park.visitTask.visitMethod.field' }) }, { value: '电话沟通', label: intl.formatMessage({ id: 'pages.park.visitTask.visitMethod.phone' }) }, { value: '微信联系', label: intl.formatMessage({ id: 'pages.park.visitTask.visitMethod.wechat' }) }]} /></Col></Row>
