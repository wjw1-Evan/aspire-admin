...
const StatisticsPage: React.FC = () => {
  ...
  const renderProjectCard = () => {
    if (!statistics?.project) {
      return <ProCard loading className="stat-card" style={{ height: 200 }} />;
    }
        ...
        <div style={{ marginBottom: 8 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
            <Text type="secondary" style={{ fontSize: 12 }}>
              {intl.formatMessage({ id: 'pages.project.statistics.overallCompletion' })}
            </Text>
        ...
        <div style={{ maxHeight: 100, overflowY: 'auto', marginTop: 8 }}>
          {Object.entries(membersByRole).length > 0 ? (
            ...
            <Empty
              ...
              description={intl.formatMessage({ id: 'pages.project.statistics.noMembers' })}
            />
          )}
        </div>
      </ProCard>
