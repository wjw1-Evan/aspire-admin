...
const RecentActivitiesCard: React.FC<RecentActivitiesCardProps> = ({ currentUser }) => {
  ...
  return (
    <ProCard
      ...
      extra={
        <Button type="link" size="small" onClick={() => history.push('/system/my-activity')} style={{ padding: 0 }}>
          <Space size={4}>
            ...
            items={
              activities.length > 0
                ? activities.map((activity) => {
                    ...
                    const urlDisplay =
                      activity.fullUrl ||
                      (activity.path && activity.queryString
                        ? `${activity.path}${activity.queryString}`
                        : activity.path);
                        ...
                        <div>
                          <Text strong>
                            {activity.action
                              ...
                              : intl.formatMessage({ id: 'pages.welcome.recentActivities.systemActivity' })}
                          </Text>
                ...
                : [
                    {
                      ...
                      content: (
                        <div>
                          <Text strong>
                            {intl.formatMessage({ id: 'pages.welcome.recentActivities.systemStart.title' })}
                          </Text>
                          <br />
                          <Text type="secondary">
                    ...
                    },
                    {
                      ...
                      content: (
                        <div>
                          <Text strong>
                            {intl.formatMessage({ id: 'pages.welcome.recentActivities.userLogin.title' })}
                          </Text>
                          <br />
                          <Text type="secondary">
                            {intl.formatMessage(
                              { id: 'pages.welcome.recentActivities.userLogin.desc' },
                              {
                                username:
                                  currentUser?.displayName ||
                                  currentUser?.username ||
                                  intl.formatMessage({ id: 'pages.welcome.user' }),
                              },
                            )}
                          </Text>
                          <div style={{ fontSize: '12px', color: 'var(--ant-color-text-tertiary)' }}>
                    ...
                    },
                    {
                      ...
                      content: (
                        <div>
                          <Text strong>
                            {intl.formatMessage({ id: 'pages.welcome.recentActivities.dataSync.title' })}
                          </Text>
                          <br />
                          <Text type="secondary">
