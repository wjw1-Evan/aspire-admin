...
const TinyAreaChart: React.FC<{ data: { value: number; time: string }[]; color: string; height?: number }> = React.memo(
  ({ data, color, height = 45 }) => {
  ...
  `;
    ...
    return (
      ...
      >
        ...
        {/* Area */}
        <path d={areaPath} fill={`url(#gradient-${color.replace('#', '')})`} stroke="none" />
