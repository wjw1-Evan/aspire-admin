...
const NodeConfigDrawer: React.FC<NodeConfigDrawerProps> = ({
  ...
  const [_departmentModalVisible, _setDepartmentModalVisible] = useState(false);
  const [_currentApproverIndex, _setCurrentApproverIndex] = useState<number | null>(null);
          ...
          items={[
            {
              ...
              children: (
                <>
                    ...
                    <Select
                      ...
                      options={Object.keys(NODE_CONFIGS).map((key) => ({
                        label: intl.formatMessage({
                          id: `pages.workflow.designer.add${key.charAt(0).toUpperCase() + key.slice(1)}`,
                        }),
                        value: key,
                      }))}
                    />
                  ...
                  <Form.Item
                    name="label"
                    label={intl.formatMessage({ id: 'pages.workflow.designer.nodeLabel' })}
                    rules={[{ required: true }]}
                  >
                  ...
                  {selectedNode?.data.nodeType === 'approval' && (
                    <>
                      <Form.Item
                        name="approveNextNodeId"
                        label={intl.formatMessage({ id: 'pages.workflow.designer.approveNextNode' })}
                      >
                        <Select
                      ...
                      <Form.Item
                        name="rejectNextNodeId"
                        label={intl.formatMessage({ id: 'pages.workflow.designer.rejectNextNode' })}
                      >
                        <Select
                      ...
                      >
                        <Select
                          options={[
                            ...
                            {
                              label: intl.formatMessage({ id: 'pages.workflow.designer.approvalType.sequential' }),
                              value: 2,
                            },
                          ]}
                        />
                        ...
                        {(fields, { add, remove }) => (
                          <>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                  ...
                                  >
                                    <Select
                                      ...
                                      options={[
                                        {
                                          label: intl.formatMessage({ id: 'pages.workflow.designer.specifiedUser' }),
                                          value: 0,
                                        },
                                        {
                                          label: intl.formatMessage({ id: 'pages.workflow.designer.specifiedRole' }),
                                          value: 1,
                                        },
                                        {
                                          label: intl.formatMessage({
                                            id: 'pages.workflow.designer.specifiedDepartment',
                                          }),
                                          value: 2,
                                        },
                                        {
                                          label: intl.formatMessage({ id: 'pages.workflow.designer.formField' }),
                                          value: 3,
                                        },
                                        {
                                          label: intl.formatMessage({ id: 'pages.workflow.designer.supervisor' }),
                                          value: 4,
                                        },
                                      ]}
                                    />
                                  ...
                                  <Form.Item
                                    ...
                                    shouldUpdate={(prev, curr) =>
                                      prev.approvers?.[name]?.type !== curr.approvers?.[name]?.type
                                    }
                                  >
                                    {({ getFieldValue }) => {
                                          ...
                                          >
                                            <Select
                                              ...
                                              placeholder={intl.formatMessage({
                                                id: 'pages.workflow.designer.selectUser',
                                              })}
                                        ...
                                        return (
                                          ...
                                          >
                                            <Select
                                              mode="multiple"
                                              placeholder={intl.formatMessage({
                                                id: 'pages.workflow.designer.selectRole',
                                              })}
                                      ...
                                      if (type === 2)
                                        return (
                                          ...
                                          >
                                            <TreeSelect
                                              placeholder={intl.formatMessage({
                                                id: 'pages.workflow.designer.selectDepartment',
                                              })}
                                              showSearch
                                      ...
                                      if (type === 3)
                                        return (
                                          ...
                                          >
                                            <Select
                                              placeholder={intl.formatMessage({
                                                id: 'pages.workflow.designer.selectFormField',
                                              })}
                                              showSearch
                                      ...
                                      if (type === 4)
                                        return (
                                          <Form.Item
                                            {...restField}
                                            name={[name, 'supervisorLevel']}
                                            rules={[{ required: true }]}
                                          >
                                            <Select
                                              placeholder={intl.formatMessage({
                                                id: 'pages.workflow.designer.selectSupervisorLevel',
                                              })}
                                              options={[
                                                {
                                                  label: intl.formatMessage({
                                                    id: 'pages.workflow.designer.supervisorLevel1',
                                                  }),
                                                  value: 1,
                                                },
                                                {
                                                  label: intl.formatMessage({
                                                    id: 'pages.workflow.designer.supervisorLevel2',
                                                  }),
                                                  value: 2,
                                                },
                                                {
                                                  label: intl.formatMessage({
                                                    id: 'pages.workflow.designer.supervisorLevel3',
                                                  }),
                                                  value: 3,
                                                },
                                                {
                                                  label: intl.formatMessage({
                                                    id: 'pages.workflow.designer.supervisorLevel4',
                                                  }),
                                                  value: 4,
                                                },
                                              ]}
                            ...
                            <Button type="dashed" onClick={() => add()} block icon={<PlusOutlined />}>
                              {intl.formatMessage({ id: 'pages.workflow.designer.addApprover' })}
                            </Button>
                          </>
                        )}
                      </Form.List>
                                          ...
                                          >
                                            <Space orientation="vertical" style={{ width: '100%' }}>
                                              ...
                                              <Form.Item
                                                ...
                                                shouldUpdate={(prev, curr) => {
                                                  const prevFormId =
                                                    prev.branches?.[name]?.conditions?.[condName]?.formId;
                                                  const currFormId =
                                                    curr.branches?.[name]?.conditions?.[condName]?.formId;
                                                  return prevFormId !== currFormId;
                                                }}
                                              >
                                                {({ getFieldValue }) => {
                                                  const formId = getFieldValue([
                                                    'branches',
                                                    name,
                                                    'conditions',
                                                    condName,
                      ...
                      <Form.Item
                        ...
                        shouldUpdate={(prevValues, currentValues) => {
                          ...
                          return (
                            ...
                            prevBranches.some(
                              (b: any, i: number) =>
                                b?.id !== currBranches[i]?.id || b?.label !== currBranches[i]?.label,
                            )
                          );
                        }}
                      >
                ...
                <>
                  {selectedNode?.data.nodeType === 'approval' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      <Form.Item
                        name="allowDelegate"
                        label={intl.formatMessage({ id: 'pages.flow.node.allowDelegate' })}
                      ...
                      <Form.Item
                        name="allowReject"
                        label={intl.formatMessage({ id: 'pages.flow.node.allowReject' })}
                        valuePropName="checked"
                      >
                        <Switch />
                      </Form.Item>
                      <Form.Item
                        name="allowReturn"
                        label={intl.formatMessage({ id: 'pages.flow.node.allowReturn' })}
                        valuePropName="checked"
                      >
                        <Switch />
                      </Form.Item>
                      <Form.Item name="timeoutHours" label={intl.formatMessage({ id: 'pages.flow.node.timeoutHours' })}>
                        <Input type="number" />
                      </Form.Item>

                      <Divider titlePlacement="left" plain>
                        {intl.formatMessage({ id: 'pages.flow.node.ccRules' })}
                      </Divider>
                        ...
                        {(fields, { add, remove }) => (
                          <>
                              ...
                              >
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                  <Form.Item {...restField} name={[name, 'type']} rules={[{ required: true }]}>
                                    <Select
                                      ...
                                      options={[
                                        ...
                                        {
                                          label: intl.formatMessage({ id: 'pages.flow.node.specifyDepartment' }),
                                          value: 2,
                                        },
                                      ]}
                                    />
                                  ...
                                  <Form.Item
                                    noStyle
                                    shouldUpdate={(prev, curr) =>
                                      prev.ccRules?.[name]?.type !== curr.ccRules?.[name]?.type
                                    }
                                  >
                                    {({ getFieldValue }) => {
                                      ...
                                      if (type === 0)
                                        return (
                                          ...
                                          >
                                            <Select
                                              mode="multiple"
                                              placeholder={intl.formatMessage({ id: 'pages.flow.node.selectUser' })}
                                              options={users.map((u) => ({ label: u.name || u.username, value: u.id }))}
                                            />
                                          </Form.Item>
                                        );
                                      if (type === 1)
                                        return (
                                          ...
                                          >
                                            <Select
                                              mode="multiple"
                                              placeholder={intl.formatMessage({ id: 'pages.flow.node.selectRole' })}
                                              options={roles.map((r) => ({ label: r.name, value: r.id }))}
                                            />
                                          </Form.Item>
                                        );
                                      if (type === 2)
                                        return (
                                          ...
                                          >
                                            <TreeSelect
                                              placeholder={intl.formatMessage({
                                                id: 'pages.flow.node.selectDepartment',
                                              })}
                                              showSearch
                                              treeDefaultExpandAll
                                              treeNodeFilterProp="title"
                            ...
                            <Button type="dashed" onClick={() => add()} block size="small" icon={<PlusOutlined />}>
                              {intl.formatMessage({ id: 'pages.flow.node.addCcRule' })}
                            </Button>
                          </>
                        )}
                      </Form.List>
                  ...
                  {selectedNode?.data.nodeType === 'start' && (
                    <Form.Item
                      ...
                      label={intl.formatMessage({ id: 'pages.flow.node.bindStartForm' })}
                    >
                      <Select
                          ...
                          <>
                            <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                              <Button
                                size="small"
                                icon={<EditOutlined />}
                                onClick={() => handleOpenFormDesigner(forms.find((f) => f.id === fid))}
                              >
                                编辑表单
                              </Button>
                              <Button size="small" icon={<PlusOutlined />} onClick={() => handleOpenFormDesigner(null)}>
                                新建表单
                              </Button>
                            </div>
                            ...
                            <>
                              {formId && (
                                <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                                  <Button
                                    size="small"
                                    icon={<EditOutlined />}
                                    onClick={() => handleOpenFormDesigner(forms.find((f) => f.id === formId))}
                                  >
                                    编辑表单
                                  </Button>
                                  <Button
                                    size="small"
                                    icon={<PlusOutlined />}
                                    onClick={() => handleOpenFormDesigner(null)}
                                  >
                                    新建表单
                                  </Button>
                                </div>
                              ...
                              {formId && (
                                <>
                                  <Form.Item
                                    name="formTarget"
                                    label={intl.formatMessage({ id: 'pages.flow.node.formTarget' })}
                                    initialValue={FormTarget.Document}
                                  >
                                    <Radio.Group>
                                      <Radio value={FormTarget.Document}>
                                        {intl.formatMessage({ id: 'pages.flow.node.formTarget.document' })}
                                      </Radio>
                                      <Radio value={FormTarget.Instance}>
                                        {intl.formatMessage({ id: 'pages.flow.node.formTarget.instance' })}
                                      </Radio>
                                    </Radio.Group>
                                  </Form.Item>
                                  <Form.Item
                                    name="formReadOnly"
                                    label={intl.formatMessage({ id: 'pages.flow.node.formReadOnly' })}
                                    valuePropName="checked"
                                  >
                                    <Switch />
                                  </Form.Item>
