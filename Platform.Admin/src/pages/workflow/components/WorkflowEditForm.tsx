    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      >
        ...
        {fullWorkflow.isActive ? (
          <span style={{ background: '#52c41a', color: '#fff', padding: '2px 8px', borderRadius: 4, fontSize: 12 }}>
            已启用
          </span>
        ) : (
          <span style={{ background: '#8c8c8c', color: '#fff', padding: '2px 8px', borderRadius: 4, fontSize: 12 }}>
            已禁用
          </span>
        )}
        <span
