...
describe('BulkOperationsPanel', () => {
  ...
  describe('初始渲染', () => {
    ...
    it('当没有选中工作流时应该禁用执行按钮', () => {
      renderWithProviders(<BulkOperationsPanel {...defaultProps} selectedWorkflowIds={[]} selectedWorkflows={[]} />);
  ...
  describe('进度显示', () => {
    it('应该显示操作进度', () => {
      ...
      // 模拟有正在进行的操作
      const _component = screen.getByTestId ? screen.getByTestId('bulk-operations-panel') : null;
  ...
  describe('错误处理', () => {
    it('应该显示操作错误信息', () => {
      const _mockOperationWithErrors = {
        ...mockBulkOperation,
