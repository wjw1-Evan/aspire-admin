import { Button, Switch, Select, Input, InputNumber, Collapse } from 'antd';
...
export function FieldPropertyPanel({ field, onChange, onClose, intl }: {
    field: FormField;
        ...
        <div className="field-property-panel">
            ...
            <div className="panel-body">
                <div className="property-group">
                    ...
                    <Input value={field.label} onChange={e => onChange({ ...field, label: e.target.value })} placeholder={intl.formatMessage({ id: 'pages.forms.field.labelPlaceholder' })} />
                </div>
                <div className="property-group">
                    <label>{intl.formatMessage({ id: 'pages.forms.field.dataKey' })}</label>
                    <Input value={field.dataKey} onChange={e => onChange({ ...field, dataKey: e.target.value })} placeholder={intl.formatMessage({ id: 'pages.forms.field.dataKeyPlaceholder' })} />
                </div>
                <div className="property-group">
                ...
                <div className="property-group">
                    ...
                    <Input value={field.placeholder} onChange={e => onChange({ ...field, placeholder: e.target.value })} placeholder={intl.formatMessage({ id: 'pages.forms.field.placeholderPlaceholder' })} />
                </div>
                <div className="property-group">
                    <label>{intl.formatMessage({ id: 'pages.forms.field.defaultValue' })}</label>
                    <Input value={field.defaultValue} onChange={e => onChange({ ...field, defaultValue: e.target.value })} placeholder={intl.formatMessage({ id: 'pages.forms.field.defaultValuePlaceholder' })} />
                </div>
