...
import { Button, Space, Input, Switch, Empty, Form, Select, Upload, Checkbox, Radio, App } from 'antd';
import { SaveOutlined, EyeOutlined, EditOutlined, CloseOutlined, UploadOutlined } from '@ant-design/icons';
...
import { FormField, FormDefinition, LIBRARY_PREFIX, getFieldTypeConfig, normalizeFieldType } from './types';
...
function SortableField({ field, selected, onSelect, onDelete, onChange }: {
    ...
    const renderFieldPreview = () => {
        ...
        switch (normalizeFieldType(field.type)) {
            case 'Text': return <Input placeholder={field.placeholder} value={field.defaultValue} onChange={e => handleChange(e.target.value)} />;
            ...
            case 'Number': return <Input type="number" placeholder={field.placeholder} value={field.defaultValue} onChange={e => handleChange(e.target.value)} />;
            case 'Date': return <Input type="date" placeholder={field.placeholder} value={field.defaultValue} onChange={e => handleChange(e.target.value)} />;
            case 'DateTime': return <Input type="datetime-local" placeholder={field.placeholder} value={field.defaultValue} onChange={e => handleChange(e.target.value)} />;
            ...
            default: return <Input placeholder={field.placeholder} value={field.defaultValue} onChange={e => handleChange(e.target.value)} />;
        }
    };
...
export const FormDesigner: React.FC<{ form: FormDefinition; onSave: (form: FormDefinition) => void; intl: any }> = ({ form, onSave, intl }) => {
