...
export async function register(body: { username: string; password: string; confirmPassword: string; email?: string; captchaId?: string; captchaAnswer?: string }): Promise<ApiResponse<unknown>> {
