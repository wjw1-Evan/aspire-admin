...
import type { ApiResponse, CaptchaResult, CurrentUser, LoginResult } from '@/types';

export type { CaptchaResult, CurrentUser, LoginResult };
...
export async function verifyImageCaptcha(
  ...
  return request('/apiservice/api/auth/captcha/verify-image', {
    method: 'POST',
    data: { captchaId, answer: captchaCode, type },
  });
}
