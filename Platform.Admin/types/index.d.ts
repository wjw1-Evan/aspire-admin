export namespace API {
  ...
  export type GET_API_CURRENT_USER_RES = {
    /** example: {"name":"管理员","avatar":"https://example.com/avatar.png","userid":"6651d054951602d87930f153","email":"admin@example.com","tags":[{"key":"0","label":"核心用户"}],"roles":["admin"],"phone":"13800138000","isLogin":true,"currentCompanyId":"6651d054951602d87930f152"} */
    data: {
      name: string;
      avatar: string;
      userid: string;
