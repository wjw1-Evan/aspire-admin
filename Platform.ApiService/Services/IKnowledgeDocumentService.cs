...
public interface IKnowledgeDocumentService
{
    ...
    /// 分页获取知识库下的文档列表
    /// </summary>
    Task<System.Linq.Dynamic.Core.PagedResult<KnowledgeDocument>> GetDocumentsAsync(string knowledgeBaseId, Platform.ServiceDefaults.Models.ProTableRequest request);
