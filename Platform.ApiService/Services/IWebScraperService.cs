...
public interface IWebScraperService
{
    ...
    Task<PagedResult<WebScrapingTask>> GetTasksAsync(ProTableRequest request, string userId, string? keyword = null, ScrapingStatus? status = null);
    ...
    Task<PagedResult<WebScrapingLog>> GetLogsAsync(ProTableRequest request, string userId, string? taskId = null);
