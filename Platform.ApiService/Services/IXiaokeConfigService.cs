...
public interface IXiaokeConfigService
{
    ...
    Task<System.Linq.Dynamic.Core.PagedResult<XiaokeConfigDto>> GetConfigsAsync(Platform.ServiceDefaults.Models.ProTableRequest queryParams, bool? isEnabled = null);
