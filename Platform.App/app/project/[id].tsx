            ...
            <View style={styles.headerActions}>
              ...
              {project.canDelete && (
                <TouchableOpacity
                  ...
                  style={styles.headerButton}
                >
                  <Ionicons name="trash-outline" size={22} color={AppStyles.colors.error} />
                </TouchableOpacity>
              )}
            </View>
          ),
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={commonStyles.card}>
          ...
          {project.startDate && (
            <View style={styles.infoRow}>
              <Ionicons name="calendar-outline" size={16} color={AppStyles.colors.textSecondary} />
          ...
          {project.budget !== undefined && project.budget !== null && (
            <View style={styles.infoRow}>
              <Ionicons name="cash-outline" size={16} color={AppStyles.colors.textSecondary} />
          ...
          <View style={styles.infoRow}>
            <Ionicons name="time-outline" size={16} color={AppStyles.colors.textSecondary} />
        ...
        <View style={commonStyles.card}>
          ...
          <View style={styles.taskStatsRow}>
            ...
            <View style={styles.taskStat}>
              <Text style={[styles.taskStatValue, { color: '#1890ff' }]}>{activeTasks}</Text>
              <Text style={styles.taskStatLabel}>进行中</Text>
            </View>
            <View style={styles.taskStat}>
              <Text style={[styles.taskStatValue, { color: '#10b981' }]}>{completedTasks}</Text>
          ...
          {tasks.length > 0 && (
            ...
            >
              ...
              <Ionicons name="arrow-forward" size={16} color={AppStyles.colors.primary} />
            </TouchableOpacity>
          )}
        </View>
      </ScrollView>
