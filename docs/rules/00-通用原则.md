...
> 详细规范请参阅：[`00-分页规范.md`](./00-分页规范.md)

### 核心要点

- **统一参数命名**：`page`（页码）和 `pageSize`（每页数量）
- **统一响应结构**：`PagedResult<T>`（`queryable`、`currentPage`、`pageSize`、`rowCount`、`pageCount`）
- **统计与分页分离**：统计接口和分页接口必须独立
